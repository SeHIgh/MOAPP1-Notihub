...
data class KeywordWeight(val keyword: String, var weight: Double, var count: Int = 0)
...
//    }
    ...
    fun updateKeywordWeights(notification: Notification) {
        ...
        for (keyword in notification.keywords) {
            ...
            val keywordWeight = keywordWeights.getOrPut(keyword) { KeywordWeight(keyword, 0.0) }
